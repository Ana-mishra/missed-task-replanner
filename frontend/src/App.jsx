...
function App() {
  ...
  function openDeleteConfirmation(task) { setDeleteError(null); setTaskToDelete(task) }
  function closeDeleteConfirmation() { if (!deleting) { setDeleteError(null); setTaskToDelete(null) } }
